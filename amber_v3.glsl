...
const float TAPER_START = 0.3;                                     // Where tapering begins (0-1, 0=immediate, 1=at end)
const float TAPER_POWER = 4.0;                                     // How dramatically the tail tapers (higher = more dramatic)
const float HEAD_WIDTH_MULTIPLIER = 1.2;                           // Make head thicker than cursor
